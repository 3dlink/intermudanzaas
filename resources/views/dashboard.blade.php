...
<html lang="en">
	<head>
		...
		{{-- STYLESHEETS --}}
		{!! HTML::style(asset('https://code.getmdl.io/1.3.0/material.cyan-indigo.min.css'), array('type' => 'text/css', 'rel' => 'stylesheet')) !!}
	...
	<body class="mdl-color--grey-100">
		...
		{!! HTML::script('https://cdnjs.cloudflare.com/ajax/libs/rome/2.1.22/rome.standalone.min.js', array('type' => 'text/javascript')) !!}

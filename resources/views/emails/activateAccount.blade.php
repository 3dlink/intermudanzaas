								...
								<tr>
									<td width="100%" valign="top" bgcolor="#e7e7e7">
										...
										<div id="synopsis" style="display: none; font-size: 1px; color: #e7e7e7; line-height: 1px; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
											{{ Lang::get('emails.emailRegistrationPwSynapsis') }}
										</div>
										<!-- END PREFACE -->
										<!-- START SEPERATOR -->
													...
													<table border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff" style="width: 580px;" class="device-width">
														<tr>
															<td align="center" valign="top" bgcolor="#ffffff" style="padding: 40px 40px 17px 40px;" class="heading">
																{{ Lang::get('emails.emailRegistrationPwTitle') }}
															</td>
														</tr>
														<!-- START SEPERATOR -->
													...
													<table border="0" cellpadding="0" cellspacing="0" align="left" bgcolor="#ffffff" style="width: 580px;" class="device-width">
														<tr>
															<td align="left" valign="top" bgcolor="#ffffff" style="padding: 25px 25px 25px 25px;" class="heading-hello">
																<font color="#525252">
																	{{ Lang::get('emails.emailRegistrationPwSalutation',['name' => $name] ) }}
																</font>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td align="left" bgcolor="#ffffff" style="padding: 0 25px 30px 25px;" class="body-text">
																<p style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 16px;line-height: 22px;text-decoration: none;font-weight: 400;">
																	{{ Lang::get('emails.emailRegistrationPwMessage') }}
																</p>
															</td>
														</tr>
														<tr>
																								...
																								<td>
																									...
																									<table align="center" border="0" cellpadding="0" cellspacing="0" style="max-width: 440px;" width="100%">
																										<tr>                                                                                           <td style="text-align: center;">
																											<div>
																														<!--[if mso]>
																															<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ url('activate/'.$code) }}" style="height:50px;v-text-anchor:middle;width: 450px;" arcsize="8%" strokecolor="#337ab7" fillcolor="#337ab7">
																															<w:anchorlock/>
																																<nter style="color:#FFFFFF;fonily:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;">
																																	{{ Lang::get('emails.emailsClickHereRegistrationBTN') }}
																																</center>
																															</v:roundrect>
																															<![endif]-->
													...
													<tr>
														<td align="center" bgcolor="#ffffff" style="padding: 8px 25px 10px 25px;" class="body-text">
															<p class="footer-text" style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 14px !important;line-height: 1.3 !important;text-decoration: none;font-weight: 400;text-align:center;">
																{{ Lang::get('emails.emailRegistrationPwFooter') }}
															</p>
														</td>
													</tr>
												</table>

...
@section('breadcrumbs')
	...
	<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
		<a itemprop="item" href="/app/paises/{{ $pais->id }}/edit">
			<span itemprop="name">
				Editando
			</span>
		</a>
	...
	<div class="mdl-grid full-grid margin-top-0 padding-0">
		<div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--3dp margin-top-0 padding-top-0">
			<div class="mdl-card__title mdl-card--expand mdl-color--primary mdl-color-text--white">
				<h2 class="mdl-card__title-text">Editando {{ ucfirst($pais->name) }}</h2>
			</div>
			{!! Form::model($pais, array('action' => array('PaisController@update', $pais->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}
							...
							<div class="mdl-grid ">
								...
								<div class="mdl-cell mdl-cell--6-col-tablet mdl-cell--6-col-desktop">
							        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label {{ $errors->has('name') ? 'is-invalid' :'' }}">
							            {!! Form::text('name', $pais->name, array('id' => 'name', 'class' => 'mdl-textfield__input', 'pattern' => '[A-Z,a-z,áéíóú, ]*')) !!}

	...
	<div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--3dp margin-top-0 padding-top-0">
		<div class="mdl-card card-new-user" style="width:100%;" itemscope itemtype="http://schema.org/Person">
			...
			<div class="mdl-card__title mdl-card--expand mdl-color--primary mdl-color-text--white">
				<h2 class="mdl-card__title-text">Subir Archivo de Cotización</h2>
			</div>

			{!! Form::open(array('action' => 'EstimacionController@uploadPDF', 'method' => 'POST', 'role' => 'form', 'files' => 'true')) !!}
				...
				<div class="mdl-grid full-grid padding-0">
					<div class="mdl-cell mdl-cell--12-col-phone mdl-cell--12-col-tablet mdl-cell--12-col-desktop">
						...
						<div class="mdl-grid ">
							...
							{!! Form::text('est', $est->id, array('id' => 'est', 'class' => 'mdl-textfield__input hidden', 'hidden')) !!}
							...
							<div class="mdl-cell mdl-cell--6-col-tablet mdl-cell--6-col-desktop">
								<div class="file_upload_container">
									<div id="file_upload_text_div" class="mdl-textfield mdl-js-textfield">
										...
										<label class="mdl-textfield__label profile_pic_label" for="file_upload_text">Archivo</label>
									</div>
									<div class="file_upload_btn">
										<label class="image_input_button mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-js-ripple-effect mdl-color-text--white">
											...
											{!! Form::file('archivo',  array('id' => 'file_upload_btn', 'class' => 'hidden mdl-file-input', 'accept'=> ".docx, .doc, .pdf" )) !!}
										</label>
									</div>
								</div>
							</div>
				...
				<div class="mdl-grid padding-top-0">
					<div class="mdl-cell mdl-cell--12-col padding-top-0 margin-top-0 margin-left-1-1">
						...
						<span class="save-actions">
							{!! Form::button('<i class="material-icons">save</i> Subir ', array('class' => 'dialog-button-save mdl-button mdl-js-button mdl-js-ripple-effect mdl-color--green mdl-color-text--white mdl-button--raised margin-bottom-1 margin-top-1 margin-top-0-desktop margin-right-1 padding-left-1 padding-right-1 ')) !!}
						</span>
			...
			<div class="mdl-card__menu mdl-color-text--white">
				...
				{{-- SAVE ICON --}}
				<span class="save-actions">
					{!! Form::button('<i class="material-icons">save</i>', array('class' => 'dialog-button-icon-save mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect', 'title' => 'Subir')) !!}
				</span>
			</div>

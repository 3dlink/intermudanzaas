...
<div class="mdl-grid full-grid margin-top-0 padding-0">
	<div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--3dp margin-top-0 padding-top-0">
		...
		<h2 class="mdl-card__title-text">Editando {{ ucfirst($box->name) }}</h2>
		</div>
		{!! Form::model($box, array('action' => array('BoxesController@update', $box->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}
						...
						<div class="mdl-grid ">
							...
							<div class="mdl-cell mdl-cell--4-col-tablet mdl-cell--6-col-desktop">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-select mdl-select__fullwidth {{ $errors->has('unit') ? 'is-invalid' :'' }}">
									{!! Form::select('unit', ['' => '', 'plg' => 'Pulgadas', 'pzas' => 'Piezas', 'm' => 'Metros', 'm2' => 'Metros cuadrados', 'm3' => 'Metros cúbicos'], $box->unit, array('class' => 'mdl-selectfield__select mdl-textfield__input', 'id' => 'unit')) !!}
									<label for="unit">
							...
							<div class="mdl-cell mdl-cell--3-col-tablet mdl-cell--3-col-desktop">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label {{ $errors->has('vmin') ? 'is-invalid' :'' }}">
									{!! Form::text('vmin', $box->vmin, array('id' => 'vmin', 'class' => 'mdl-textfield__input', 'pattern' => '\d+')) !!}
							...
							<div class="mdl-cell mdl-cell--3-col-tablet mdl-cell--3-col-desktop">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label {{ $errors->has('vmax') ? 'is-invalid' :'' }}">
									{!! Form::text('vmax', $box->vmax, array('id' => 'vmax', 'class' => 'mdl-textfield__input', 'pattern' => '\d+')) !!}
							...
							<div class="mdl-cell mdl-cell--6-col-tablet mdl-cell--6-col-desktop">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label {{ $errors->has('factor') ? 'is-invalid' :'' }}">
									{!! Form::text('factor', $box->factor, array('id' => 'factor', 'class' => 'mdl-textfield__input', 'pattern' => '\d+(\.\d+)?')) !!}
							...
							<div class="mdl-cell mdl-cell--12-col-tablet mdl-cell--12-col-desktop">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label {{ $errors->has('tooltip') ? 'is-invalid' :'' }}">
									{!! Form::text('tooltip', $box->tooltip, array('id' => 'tooltip', 'class' => 'mdl-textfield__input')) !!}
							...
							<div class="mdl-cell mdl-cell--12-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label {{ $errors->has('description') ? 'is-invalid' :'' }}">
									{!! Form::textarea('description',  $box->description, array('id' => 'description', 'class' => 'mdl-textfield__input')) !!}

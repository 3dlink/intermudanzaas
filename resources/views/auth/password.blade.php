    ...
    <main class="mdl-layout__content" style="margin-top: 3%;">
        <div class="mdl-card mdl-shadow--2dp">
            ...
            <div class="mdl-card__supporting-text">
               ...
               {!! Form::open(array('url' => 'app/password/email', 'method' => 'POST', 'class' => 'auth-form', 'id' => 'reset')) !!}
           ...
           <div class="mdl-card__actions mdl-card--border">
            ...
            {!! HTML::link(url('app/auth/login'), Lang::get('auth.login'), array('id' => 'login', 'class' => 'mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect right')) !!}
